...
function setLanguage()
{
    if (translate == false){
        ...
        document.querySelector('#pas p:nth-child(3)').textContent = 'BABKINA'
        document.querySelector('#pas p:nth-child(4)').textContent = 'DARIA'
        document.querySelector('#pas p:nth-child(5)').textContent = 'VLADIMIROVNA'
        ...
        document.querySelector('#pas p:nth-child(3)').textContent = 'БАБКИНА'
        document.querySelector('#pas p:nth-child(4)').textContent = 'ДАРЬЯ'
        document.querySelector('#pas p:nth-child(5)').textContent = 'ВЛАДИМИРОВНА'
